            ...
            <div class="row section-separator xs-column-reverse vertical-middle-content home-padding">
                <div class="col-sm-6">
                    <div class="mh-header-info">
                        ...
                        <h2 class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s">Rizky Asep Sutrisna</h2>
                        ...
                        <ul class="social-icon wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.7s">
                            <li><a href="https://www.facebook.com/rizky.asepsutrisna/"><i class="fa fa-facebook"></i></a></li>
                            <li><a href="https://github.com/rizkyasepsutrisna"><i class="fa fa-github"></i></a></li>
                            <li><a href="https://www.linkedin.com/in/rizky-asep-sutrisna-a0936817a/"><i class="fa fa-linkedin"></i></a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-6">
        ...
        <div class="row section-separator">
            ...
            <div class="col-sm-12 col-md-6">
                <div class="mh-about-inner">
                    ...
                    <p class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s">Hello, I’m a Asep, web-developer based on Bandung.
        ...
        <div class="row section-separator">
            ...
            <div class="col-sm-4">
                <div class="mh-service-item shadow-1 dark-bg wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.3s">
                    ...
                    <h3>UI Design</h3>
                    <p>
                        I make ui designs using figma, and the designs I make usually use templates or make my own.
                    </p>
                </div>
            </div>
            <div class="col-sm-4">
                    ...
                    <div class="mh-education">
                        ...
                        <div class="mh-education-deatils">
                            ...
                            <div class="mh-education-item dark-bg wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.3s">
                                <h4>Sdn 1 Way Urang <a href="https://goo.gl/maps/rKpaLYkba7HZoYaEA">Primary School</a></h4>
                                <div class="mh-eduyear">2006-2012</div>
                                <p>Saya lulus pada tahun 2012 dengan mendapatkan nilai terbaik </p>
                            </div>
                            <!-- Education Institutes-->
                            <div class="mh-education-item dark-bg wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.5s">
                                <h4>Smp Negeri 1 Kalianda <a href="https://goo.gl/maps/7njQzW6wkGttg53Y7">Junior High School</a></h4>
                                <div class="mh-eduyear">2012-2015</div>
                                <p>Saya lulus pada tahun 2012 dengan mendapatkan nilai rata rata 80 </p>
                            </div>
                            <!-- Education Institutes-->
                            <div class="mh-education-item dark-bg wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.6s">
                                <h4>Sma Negeri 1 Kalianda <a href="https://goo.gl/maps/8aQyg8fqaqaTFYSU7">Senior High School</a></h4>
                                <div class="mh-eduyear">2015-2017</div>
                                <p>Saya lulus pada tahun 2012 dengan mendapatkan nilai rata rata 78 </p>
                            </div>
                            <!-- Education Institutes-->
                            <div class="mh-education-item dark-bg wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.6s">
                                <h4>D3 Teknik Informatika Telkom University <a href="https://goo.gl/maps/dfb89cZw9fvCtxqL6">Lecture</a></h4>
                                <div class="mh-eduyear">2015-2017</div>
                                <p>Saya Lulus pada tahun 2020 dengan mendapatkan IPK 3.36 </p>
                            </div>
                            <!-- Education Institutes-->
                            <div class="mh-education-item dark-bg wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.6s">
                                <h4>S1 Teknik Informatika Telkom University <a href="https://goo.gl/maps/dfb89cZw9fvCtxqL6">Lecture</a></h4>
                                <div class="mh-eduyear">2021</div>
                                <p>Saya Sedang masa studi ekstensi di S1 Teknik Informatika </p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="mh-work">
                        ...
                        <div class="mh-experience-deatils">
                            ...
                            <div class="mh-work-item dark-bg wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.4s">
                                <h4>IT SUPPORT | Telkom Indonesia Graha Merah Putih Bandung<a href="https://goo.gl/maps/42vTXCTWM48tPkzy8"> Magang</a></h4>
                                <div class="mh-eduyear">2018-2019</div>
                                <span>Responsibility :</span>
                                <ul class="work-responsibility">
                                    <li><i class="fa fa-circle"></i>Project Website</li>
                                </ul>
                            </div>
                            <!-- Education Institutes-->
                            <div class="mh-work-item dark-bg wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.6s">
                                <h4>IT FRONT-END | Bandung Techno Park<a href="https://goo.gl/maps/HNfBHLLy74spZQRL6"> Magang</a></h4>
                                <div class="mh-eduyear">2019-2020</div>
                                <span>Responsibility :</span>
                                <ul class="work-responsibility">
                                    <li><i class="fa fa-circle"></i>Project Website BTPSAE</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <form id="contactForm" class="single-form quate-form wow fadeInUp" data-toggle="validator">
                                ...
                                <div class="row">
                                    ...
                                    <div class="btn-form col-sm-12">
                                        <a href="mailto:rizkyasepsutrisna@email.com"><button type="submit" class="btn btn-fill btn-block" id="form-submit">Send Message</button></a>
                                    </div>
                                </div>
                            </form>
                        </div>
